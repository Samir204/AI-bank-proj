...
# API_KEY = os.environ.get(api_key="AQ.Ab8RN6LVf-sj9ZJrr5G9HA6wdbIaEieQIg-nGOCPi7-Auld2Zg")
# if not API_KEY:
#     raise RuntimeError(
...
client = genai.Client(api_key="AQ.Ab8RN6LVf-sj9ZJrr5G9HA6wdbIaEieQIg-nGOCPi7-Auld2Zg")
